...
"""
MARKOV_CTX = {
    'wp' : [4.9800, 4.8119, 5.6298, 6.3050, 6.7800, 7.0469],
    'dyck' : [1.3888, 1.1604, 1.1765, 1.0077, 1.0747, 1.1769],
    'ndfa' : [3.5141, 0.7293, 0.3716, 0.3918, 0.4352, 0.5322],
    'toy' : [4.2825, 2.6090, 1.9711, 2.4323, 2.8710, 3.3567],
    'bits': [1.1875, 1.1961, 1.2226, 1.2693, 1.3434, 1.4328],
    'champ': [3.3676, 2.4247, 2.6952, 3.3094, 3.9252, 4.3293]
}
